(defproject fix-demo-simple "0.1.0-SNAPSHOT"
  :description "FIXDemoSimple demonstrates how to build messages and applications with QuickFIX/J. A sample requester and a provider can be started as Clojure applications with Leiningen."
  :url "https://bitbucket.org/stefan_we/fixdemosimple/"
